package com.htht.job.admin.common.exception;
 ...
 * 全局异常处理
 */
@RestControllerAdvice(basePackages = {"com.htht.job.admin"})
@Slf4j
public class AllExceptionAdvice {
    ...
    @ExceptionHandler(value = {CommonException.class,XxlJobException.class})
