package com.htht.job.core.context;
...
public class XxlJobHelper {
     ...
     * @param appendLog
     */
    protected static boolean logDetail(StackTraceElement callInfo, String appendLog) {
        XxlJobContext xxlJobContext = XxlJobContext.getXxlJobContext();
        if (xxlJobContext == null) {
            return false;
        }
        ...
        // TODO 注释掉 线程名称相关信息
        stringBuffer.append(DateUtil.formatDateTime(new Date(), DateConstant.YYYY_MM_DD_HH_MM_SS)).append(" ")
...
//                .append("["+ Thread.currentThread().getName() +"]").append(" ")
    ...
    public static String  getRedisKey() {
        ...
        return xxlJobContext.getRedisKey();
    }

    public static boolean setRedisKey(String redisKey) {
        XxlJobContext xxlJobContext = XxlJobContext.getXxlJobContext();
        if (xxlJobContext == null) {
            return false;
        }
        xxlJobContext.setRedisKey(redisKey);
        return true;
    }
