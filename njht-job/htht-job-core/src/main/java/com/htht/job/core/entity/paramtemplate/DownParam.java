...
public class DownParam {
    ...
    public void setDownloadDate(String downloadDate) {
        // 将数据转成List并拿 , 拼接返回
        List<String> list = GsonTool.fromJsonList(downloadDate, String.class);
        this.downloadDate = String.join(",", list);
    }
    ...
    public static void main(String[] args) {
        String s = "['1','2']";
        List<String> list = GsonTool.fromJsonList(s, String.class);
