...
//	private String dataFilePattern;//文件名称格式
    ...
    private String dateType;//1表示最近N小时，2表示时间范围

    private String startDate;//开始时间
    private String endDate;//结束时间
    private Integer rangeDay;//处理小时，当前时间往前数几小时

    private String timeRange;//投影时间范围

    private String extArgs;//补充参数
    private String formate;//数据格式
    private String mosaicMode;//拼接模式
    private String dayAndNight;//处理范围
    private String orbitIdentify;//观测标识
    private String mosaicEnvelopes;//拼接有效范围
    private String outputType;//拼接输出类型


    private String blockExeLocation;//分幅算法位置
    private String blockIdentify;//分幅标识 零度分幅十度分幅
    private String blocksEnvelope;//数据有效范围 （预定义分幅）
    private String blocksEnvelopeID;//数据有效范围（自定义分幅）
    private String blockType;//custom 预定义分幅 identify 自定义分幅

    private String scandisk; // 扫描磁盘

    /**
     * 是否多个输入文件
     */
    private String isManyInput = "0";

    /**
     * 多个输入文件 需指定SSLRID， 例如 FY3E_MERSI_L1_1000M
     */
    private String sslRid;

    public String getIsManyInput() {
        return isManyInput;
    }

    public void setIsManyInput(String isManyInput) {
        this.isManyInput = isManyInput;
    }

    public String getSslRid() {
        return sslRid;
    }

    public void setSslRid(String sslRid) {
        this.sslRid = sslRid;
    }
    ...
    public String getScandisk() {
        return scandisk;
    }

    public void setScandisk(String scandisk) {
        this.scandisk = scandisk;
    }

    public String getBlocksEnvelopeID() {
        return blocksEnvelopeID;
    }

    public void setBlocksEnvelopeID(String blocksEnvelopeID) {
        this.blocksEnvelopeID = blocksEnvelopeID;
    }
    ...
    public String getBlocksEnvelope() {
        return blocksEnvelope;
    }

    public void setBlocksEnvelope(String blocksEnvelope) {
        this.blocksEnvelope = blocksEnvelope;
    }

    public String getBlockIdentify() {
        return blockIdentify;
    }

    public void setBlockIdentify(String blockIdentify) {
        this.blockIdentify = blockIdentify;
    }

    public String getMosaicMode() {
        return mosaicMode;
    }
    ...
    public String getMosaicEnvelopes() {
        return mosaicEnvelopes;
    }

    public void setMosaicEnvelopes(String mosaicEnvelopes) {
        this.mosaicEnvelopes = mosaicEnvelopes;
    }
    ...
    public String getOrbitIdentify() {
        return orbitIdentify;
    }

    public void setOrbitIdentify(String orbitIdentify) {
        this.orbitIdentify = orbitIdentify;
    }
