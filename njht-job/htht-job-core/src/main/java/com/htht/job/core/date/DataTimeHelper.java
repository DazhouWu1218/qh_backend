package com.htht.job.core.date;
...
public class DataTimeHelper {
	...
	public static void main(String[] args) {
		String fileName = "20221013.success";
		String regex = "^yyyyMMdd";
		getDataTimeFromFileNameByPattern(fileName,regex);
	}
	...
	public static String getRegFromDatePattern(String datePattern){
