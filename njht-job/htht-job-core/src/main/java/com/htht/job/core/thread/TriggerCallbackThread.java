...
import com.htht.job.core.util.JdkSerializeTool;
        ...
        for (AdminBiz adminBiz: XxlJobExecutor.getAdminBizList()) {
            try {
                ...
                if (callbackResult!=null && ReturnT.SUCCESS_CODE == callbackResult.getCode()) {
                    callbackLog(callbackParamList, "<br>----------- pie-job job callback finish.");
                    callbackRet = true;
                    break;
                } else {
                    callbackLog(callbackParamList, "<br>----------- pie-job job callback fail, callbackResult:" + callbackResult);
                }
            } catch (Exception e) {
                callbackLog(callbackParamList, "<br>----------- pie-job job callback error, errorMsg:" + e.getMessage());
            }
        }
        if (!callbackRet) {
