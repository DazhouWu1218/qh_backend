	...
	public static String matchIssue(Date date,String str,String cycle){
		...
		if("COAY".equals(cycle)){//年周期
			...
			if(month<3){
				...
				issue = DateUtil.formatDateTime(calendar.getTime(), "yyyy")+"12010000";
			}else if(month<6){
		...
		}else if("COSD".equals(cycle) ||"COAW".equals(cycle)){// COSD	Cycle of Seven Days周周期合成产品 
			int day = calendar.get(Calendar.DAY_OF_MONTH);
			if(day<8){
				issue = DateUtil.formatDateTime(calendar.getTime(), "yyyyMM")+"010000";
			}else if(day <15){
			...
			issue = DateUtil.formatDateTime(calendar.getTime(), "yyyyMMddHH"+"00");
...
//	}
	 ...
	 * @return
	 */
	public static long getMinDateToMillis(Calendar c) {
	 ...
	 * @return
	 */
//	public static Calendar getCalendarByCycle(Calendar calendar, String cycle, int n){
//		
//		if(cycle == null || "".equals(cycle)){
//			
//			return null;
//		}
//		int days = CycleConstant.CycleMap.get(cycle);
//		String issue = matchIssue(calendar.getTime(), cycle);
//		calendar.setTime(DateUtil.strToDate(issue, DateConstant.YYYYMMDDHHMM)); 
//		calendar.add(Calendar.DAY_OF_YEAR, -days*n);	
//		
//		return calendar;
//	}
//	public static Date getDateByCycle(Calendar calendar, String cycle, int n){
//		return getCalendarByCycle(calendar, cycle, n).getTime();
//	}
	
//	public static void main(String[] args) {
//		Date date = getDateByCycle(Calendar.getInstance(), "COTD", 1);
//		System.out.println(DateUtil.dateToStr(date));
//		date = getDateByCycle(Calendar.getInstance(), "COTD", 0);
//		System.out.println(DateUtil.dateToStr(date));
//	}
