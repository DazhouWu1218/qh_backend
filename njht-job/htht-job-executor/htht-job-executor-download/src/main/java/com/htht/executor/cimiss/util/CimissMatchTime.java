...
public class CimissMatchTime {
	...
	private CimissMatchTime (){

	}

	public static String match(Calendar c, String str, String timeKey) {
		...
		int dayNum = 0;
		if (timeKey.endsWith("YER") || timeKey.endsWith("MON")) {
			dayNum = 1;
