...
public class H8FileOperate {

	public H8FileOperate() {
	}
	 ...
	 * @return boolean
	 */
	public void newFile(String filePathAndName, String fileContent,String charset) {
		...
		try {
			...
			try(
				OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream(myFilePath), charset);
				){
