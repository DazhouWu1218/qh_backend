...
public class MatchTime {
	...
	public static String matchIssue(Date date,String str,String cycle){
		...
		}else if("COSD".equals(cycle)){
			// COSD	Cycle of Seven Days周周期合成产品 TODO
			int day = calendar.get(Calendar.DAY_OF_MONTH);
			if(day<8){
				issue = DateUtil.formatDateTime(calendar.getTime(), "yyyyMM")+"010000";
			}else if(day <15){
		...
		}else if("COED".equals(cycle)){
			// COED	Cycle of Eight Days周周期合成产品 TODO
			issue = DateUtil.formatDateTime(calendar.getTime(), "yyyyMMdd")+"0000";
		}else if("COFD".equals(cycle)){
			//COFD   Cycle of Five Day  侯周期合成产品 TODO
			int day = calendar.get(Calendar.DAY_OF_MONTH);
			if(day<6){
				issue = DateUtil.formatDateTime(calendar.getTime(), "yyyyMM")+"010000";
			}else if(day <11){
	...
	/**
	 * 根据不同的周期，计算Calendar的变化
	 * @param c
	 * @param cycle
	 * @return
	 */
	public static Calendar getCalendarByCycle(Calendar c, String cycle){
		if("COAY".equals(cycle)){
			//年周期合成产品
			...
			// COED	Cycle of Eight Days周周期合成产品
			...
			//COOH  Cycle of One Hour	小时周期合成产品
			c.add(Calendar.HOUR, 1);
		}else if("COTM".equals(cycle)){
			//COTM  Cycle of Ten Minute 10min周期
			c.add(Calendar.MINUTE, 10);
		}else if("COOM".equals(cycle)){
			//COOM Cycle of One Minute 分钟周期合成产品
			c.add(Calendar.DAY_OF_YEAR, 1);
		}
	 ...
	 * @return
	 */
	public static String getDateByIssueAndCycle(String issue, String cycle) {
	...
	public static String getStrDateByIssueAndCycle(String issue, String cycle) {
