...
public class TriggerParam implements Serializable {
     ...
     * 步骤执行后的返回值存放区
     */
    private LinkedHashMap<String, ?> stepReturn;
    ...
    public LinkedHashMap<String, ?> getStepReturn() {
        return stepReturn;
    }

    public void setStepReturn(LinkedHashMap<String, ?> stepReturn) {
